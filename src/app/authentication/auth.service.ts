...
const SIGNIN_URL = environment.base_url + '/auth/admin/login';
...
export class AuthService {
    ...
    private handleAuthentication(responseData: AuthSignInResponseData, self: any) {
        ...
        return this.snackService.message('You have successfully logged in');
    }
    ...
    private handleError(errorResponse: HttpErrorResponse) {
        ...
        switch (errorResponse.status) {
            ...
            case 403:
                errorMessage = `Forbidden error occurred: ${errorResponse.error.message}`;
                break;
